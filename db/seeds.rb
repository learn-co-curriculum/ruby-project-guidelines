...
m3 = Movie.create(title: "Sleepless in Seattle",  genre_id: rom_com.id, showtime: 11, theater_id: commando.id)
m4 = Movie.create(title: "Rush Hour",  genre_id: action.id, showtime: 4, theater_id: commando.id)
m5 = Movie.create(title: "The Matrix",  genre_id: action.id, showtime: 12, theater_id: commando.id)
m6 = Movie.create(title: "Inside Man",  genre_id: action.id, showtime: 6, theater_id: commando.id )
m7 = Movie.create(title: "Mars Attacks",  genre_id: sci_fi.id, showtime: 9, theater_id:commando.id )
m8 = Movie.create(title: "Predator",  genre_id: sci_fi.id, showtime: 12, theater_id: commando.id )
m9 = Movie.create(title: "Jurassic Park",  genre_id: sci_fi.id, showtime: 4, theater_id: commando.id )
m10 = Movie.create(title: "I Know What You Did Last Summer",  genre_id: slasher.id, showtime: 11, theater_id: commando.id )
m11 = Movie.create(title: "Scream",  genre_id: slasher.id, showtime: 12, theater_id: commando.id )
m12 = Movie.create(title: "Halloween",  genre_id: slasher.id, showtime: 10, theater_id:commando.id )
